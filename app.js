...
// game variable of a new instance of Phaser.Game to set up our game
...
// bring in images for our application
function preload () {
      this.load.image("background", "assets/background.png");
      this.load.image("road", "assets/road.png");
      // this.load.image("column", "assets/pine_variant_3.png");
...
function create () { // generate elements that will appear in our game
      // to aid dynamic resizing
      const { width, height } = this.sys.game.config;

      // to position upper left corner of the background at (0, 0)
      ...
      // to scale 1st set of columns relative to screen size
      for (let i = 1; i <= 1; i++) {
      ...
      // to scale 2nd set of columns relative to screen size
      for (let i = 1; i <= 1; i++) {
      ...
      // to create a single, static road variable
      ...
      // setScale() to specify that we want the road to be twice as big as its original size
      // since we changed the size refreshBody() required for the physics to work
